        ...
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
          <div className=" relative ">
            ...
            <div className="lg:max-w-xl lg:pr-5 relative z-40">
              ...
              <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                Savor Every Bite: Your Culinary
              ...
              <p className="text-base text-gray-700">
                FeastFinder: Savor Every Bite. Your Culinary Companion for
                discovering delightful dishes, sharing recipes, and exploring
                local flavors
              </p>
          ...
          <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
            ...
            <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
              <img src="https://img.freepik.com/free-photo/fruit-salad-spilling-floor-was-mess-vibrant-colors-textures-generative-ai_8829-2895.jpg?w=360&t=st=1715080900~exp=1715081500~hmac=99e7288661ea02f128d1e8be3d6ca8a40f4f0862bc69f8d86ad4e95899c8c72f"></img>
            </div>
          </div>
        </div>
      </div>
